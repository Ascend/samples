...
script_path=${script_path_temp}/../../cplusplus/level2_simple_inference/6_other/acl_execute_conv2d/scripts
...
function main() {
    ...
    cd ${script_path} && > result.txt && atc --singleop=../model/op_list.json --output=../model --soc_version=Ascend310
