...
aipp_cfg="https://obs-9be7.obs.cn-east-2.myhuaweicloud.com/models/googlenet_imagenet_multi_batch/insert_op.cfg"
model_name="googlenet_multibatch"

data_source="https://obs-9be7.obs.cn-east-2.myhuaweicloud.com/models/googlenet_imagenet_multi_batch/test_image/"
data_name="dog1_1024_683.bin"
data_name2="dog2_1024_683.bin"
verify_source="https://obs-9be7.obs.cn-east-2.myhuaweicloud.com/models/googlenet_imagenet_multi_batch/verify_image/"
verify_name="verify_test1.txt"
project_name="cplusplus_googlenet_imagenet_multi_batch"

script_path_temp="$( cd "$(dirname $BASH_SOURCE)" ; pwd -P)"
script_path=${script_path_temp}/../../cplusplus/level2_simple_inference/1_classification/googlenet_imagenet_multi_batch/scripts
