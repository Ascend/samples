...
aipp_cfg="https://obs-9be7.obs.cn-east-2.myhuaweicloud.com/models/YOLOV3_coco_detection_multi_thread_VENC/aipp_yuv.cfg"
model_name="yolov3"
...
conf_file_name="yolov3_coco_detection_multi_thread.conf"

script_path_temp="$( cd "$(dirname $BASH_SOURCE)" ; pwd -P)"
script_path=${script_path_temp}/../../cplusplus/level2_simple_inference/n_performance/1_multi_process_thread/yolov3_coco_detection_multi_thread/scripts
...
function main() {
    ...
    cp ${project_path}/data/video1.mp4 ${project_path}/data/person0.mp4 
    cp ${project_path}/data/video1.mp4 ${project_path}/data/person1.mp4 
    cp ${project_path}/data/video1.mp4 ${project_path}/data/person2.mp4 
    cp ${project_path}/data/video1.mp4 ${project_path}/data/person3.mp4 
