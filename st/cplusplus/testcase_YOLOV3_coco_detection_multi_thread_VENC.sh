...
script_path=${script_path_temp}/../../cplusplus/level2_simple_inference/n_performance/1_multi_process_thread/YOLOV3_coco_detection_multi_thread_VENC/scripts
...
function main() {
    ...
    wget -O ${project_path}/data/video2.mp4 https://obs-9be7.obs.cn-east-2.myhuaweicloud.com/models/YOLOV3_coco_detection_multi_thread_VENC/test_image/video2.mp4 --no-check-certificate
