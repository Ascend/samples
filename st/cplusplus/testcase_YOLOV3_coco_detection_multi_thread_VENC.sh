...
function main() {
    ...
    wget -O ${project_path}/data/video2.mp4 https://c7xcode.obs.cn-north-4.myhuaweicloud.com/models/YOLOV3_coco_detection_multi_thread_VENC/test_image/video2.mp4 --no-check-certificate
