...
- [for_atlas200dk_1.3x.0.0_c++](https://gitee.com/ascend/samples/tree/master/Atlas200DK-UART-CAR/for_atlas200dk_1.3x.0.0_c++)：该分支是运行在200DK上基于1.3x.0.0版本的C++样例。使用dvpp对视频帧进行预处理，对预处理后的视频帧进行手势识别，最后进行相应后处理。
</blockquote></details>
