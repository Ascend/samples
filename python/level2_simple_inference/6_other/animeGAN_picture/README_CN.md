...
| 第三方依赖 | numpy, opencv, python-acllite | 请参考[第三方依赖安装指导（python样例）](../../../environment)完成对应安装 |
...
2. 获取此应用中所需要的原始网络模型。
    ...
    wget https://c7xcode.obs.cn-north-4.myhuaweicloud.com/models/animeGAN/AnimeGAN.pb     
...
推理前：
![输入图片说明](https://images.gitee.com/uploads/images/2021/1110/105421_891f1905_8083019.png "origin.png")

推理后：
![输入图片说明](https://images.gitee.com/uploads/images/2021/1110/105155_b1460a98_8083019.jpeg "testb.jpg")
