...
@LastEditTime: 2020-12-17 23:10:08
@FilePath: /colorization_video_python/atlas_utils/presenteragent/presenter_message.py
"""
# !/usr/bin/env python
# -*- coding:utf-8 -*-
import struct
...
def open_channel_request(channel_name, content_type):
    """
    pack open channel request message
    """
...
def image_frame_request(image_width, image_height, image_data, detection_result):
    """
    pack image frame request message
    """
...
def is_open_channel_response(msg_name):
    """
    Determine whether msg_name and _OPENCHANNELRESPONSE consistent
    """
...
def is_image_frame_response(msg_name):
    """
    Determine whether msg_name and _PRESENTIMAGERESPONSE consistent
    """
