...
Function: uses the DeepLabv3+ model to perform semantic segmentation.  
...
| Third-party dependency| opencv, numpy, python-acllite | Select required dependencies. See [Third-Party Dependency Installation Guide (Python Sample)](https://github.com/Ascend/samples/tree/master/python/environment).|
...
2. Obtain the source model required by the application.
    ...
    |---|---|---|
    | DeepLabv3+| An inference model for semantic segmentation| Download the model by referring to [https://github.com/Ascend/ModelZoo-TensorFlow/tree/master/TensorFlow/contrib/cv/deeplab-v3-plus](https://github.com/Ascend/ModelZoo-TensorFlow/tree/master/TensorFlow/contrib/cv/deeplab-v3-plus).|
    ```
...
1. Run the following commands to upload the **deeplabv3_pascal_pic** directory in the development environment to any directory in the operating environment, for example, **/home/HwHiAiUser**, and log in to the operating environment (host) as the running user (**HwHiAiUser**):
    ```
...
Before inference:
![Input Image Description](https://images.gitee.com/uploads/images/2021/1110/094820_ce514a67_8083019.jpeg "dog1.jpg")

After inference:
![Input Image Description](https://images.gitee.com/uploads/images/2021/1110/094833_93d8b4a1_8083019.jpeg "1.jpg")
