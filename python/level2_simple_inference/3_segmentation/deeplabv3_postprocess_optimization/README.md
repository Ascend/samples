...
2. Obtain the source model required by the application.
    ...
    |---|---|---|
    | deeplabv3| An inference model for semantic segmentation  |  For details, see https://www.hiascend.com/en/software/modelzoo/detail/C/d2a3b34288ca4a259ae9906decee4ede |
...
2. <a name="step_2"></a>Run the sample.
   ...
   # Python multi-process processing
...
![Input Image Description](../figures/416e32a4d97f3646cc4dcb889fa8f37.png)
