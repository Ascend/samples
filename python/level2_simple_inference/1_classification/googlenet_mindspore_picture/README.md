...
For details about the training process, see [GoogLeNet MindSpore Training](https://gitee.com/mindspore/models/tree/master/official/cv/googlenet).
...
1. Run the following commands to upload the **googlenet_mindspore_picture** directory in the development environment to any directory in the operating environment, for example, **/home/HwHiAiUser**, and log in to the operating environment (host) as the running user (**HwHiAiUser**):
    ```
