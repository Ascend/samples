...
2. Obtain the source model required by the application.
    ...
    | ------------ | ------------------------------------------------ | ------------------------------------------------------------ |
    | googlenet    | Image classification inference model. It is a GoogLeNet model based on Caffe.| Download the model and weight file by referring to [README.md](https://github.com/Ascend/ModelZoo-PyTorch/tree/master/PyTorch/contrib/cv/classification/GoogleNet_ID1623_for_PyTorch/ATC_googlenet_pth_AE). |
