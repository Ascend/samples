...
2. Obtain the required model.
    ...
    | ------------ | ----------------------------------------- | ------------------------------------------------------------ |
    | VGG16   | TensorFlow-based VGG16 model for cat and dog classification.| Download the original model and the corresponding .cfg file by referring to [README.md](https://github.com/Ascend/ModelZoo-TensorFlow/tree/master/TensorFlow/contrib/cv/classification_cat_dog/ATC_VGG16_tf_AE). |
