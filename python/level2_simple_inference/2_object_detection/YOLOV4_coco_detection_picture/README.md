...
Function: uses the YOLOv4 model to perform prediction and inference on an input image and print the results on an output image.   
Input: JPG images.    
...
| Third-party dependencies| opencv, python-acllite | Select required dependencies. See [Third-Party Dependency Installation Guide (Python Sample)](https://github.com/Ascend/samples/tree/master/python/environment).|
...
2. Obtain the offline model required by the application.
    ```
...
After the execution is complete, the JPG images with the inference results are saved in the **out** directory.  
![Input Image Description]( https://images.gitee.com/uploads/images/2021/1103/094054_6befba17_7647177.png "image-20211103093400895.png")
