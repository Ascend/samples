...
2. 获取此应用中所需要的原始网络模型。
    ...
    |  **模型名称**  |  **模型说明**  |  **模型下载路径**  |
    |---|---|---|
    |  yolo3_resnet18.pb| YOLOv3  |  请参考[https://gitee.com/ascend/modelzoo/tree/master/contrib/Research/cv/resnet18_yolov3/ATC_resnet18_yolo3_tf_AE](https://gitee.com/ascend/modelzoo/tree/master/contrib/Research/cv/resnet18_yolov3/ATC_resnet18_yolo3_tf_AE)目录中README.md下载原始模型章节下载模型文件和配置文件。 |
