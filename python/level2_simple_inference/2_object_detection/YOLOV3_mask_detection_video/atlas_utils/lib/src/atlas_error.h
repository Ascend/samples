...
const int ATLAS_ERROR_CREATE_ACL_CONTEXT = 4;
const int ATLAS_ERROR_CREATE_THREAD = 5;
const int ATLAS_ERROR_CREATE_STREAM = 6;
const int ATLAS_ERROR_GET_RUM_MODE = 7;
const int ATLAS_ERROR_APP_INIT = 8;
const int ATLAS_ERROR_DEST_INVALID = 9;
const int ATLAS_ERROR_IMWRITE = 10;
