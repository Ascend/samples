...
2. Obtain the source model required by the application.
    ...
    | ------------ | -------------------------------- | ------------------------------------------------------------ |
    | YOLOv3 | Caffe-YOLOV3-based object detection model.| Download the model and weight files by referring to [README.md](https://github.com/Ascend/ModelZoo-TensorFlow/tree/master/TensorFlow/contrib/cv/yolov3/ATC_yolov3_caffe_AE). |
    ```
