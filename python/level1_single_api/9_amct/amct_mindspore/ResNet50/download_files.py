...
RESNET50_MODEL_DEFINE_URL = \
    'https://raw.githubusercontent.com/mindspore-ai/mindspore/v1.1.0/model_zoo/official/cv/resnet/src/resnet.py'
RESNET50_MODEL_DATASET_URL = \
    'https://raw.githubusercontent.com/mindspore-ai/mindspore/v1.1.0/model_zoo/official/cv/resnet/src/dataset.py'
RESNET50_LR_GENERATOR_URL = \
    'https://raw.githubusercontent.com/mindspore-ai/mindspore/v1.1.0/model_zoo/official/cv/resnet/src/lr_generator.py'
HCCL_TOOLS = \
...
def download_file(url_path, file_name):
    ...
    download_file_path = os.path.join(CUR_DIR, 'src', file_name)
