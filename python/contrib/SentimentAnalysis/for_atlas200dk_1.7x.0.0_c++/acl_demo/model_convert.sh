...
/usr/local/Ascend/atc/bin/atc --model=../tf_total_sentiment/snapshots/models.pb --framework=3 --input_shape="w:500,16" --output=../tf_total_sentiment/snapshots/models --soc_version=Ascend310 --log=debug --out_nodes="s/logits:0"
