    ...
    - 3.0.0版本  
        ...
        1. 参考下方链接获取此应用中所用到的原始网络模型。
            ...
            **cd $HOME/samples/python/contrib/cartoonGAN_picture/model** 。   
            | **模型名称** | **模型说明**                   | **模型下载路径**                                             |
            | ------------ | ------------------------------ | ------------------------------------------------------------ |
            | CartoonGAN     | 将普通照片转换为卡通风格的图片。 | 请参考https://github.com/Ascend/modelzoo/tree/master/contrib/TensorFlow/Research/cv/cartoonization/ATC_cartoonization_tf_AE 原始模型章节，下载**原始模型**及**对应的cfg文件**。 |
