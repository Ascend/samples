...
Result DvppJpegD::InitDecodeOutputDesc(ImageData& inputImage)
{
    ...
    /*The prediction interface requires the memory allocated by aclrtMallocHost, which will be needed in the current application running on AI1
Copy the image memory multiple times, don't use it temporarily.
