...
2. Obtain the source model required by the application.
    ...
    | -------------- | --------------------------------- | ---------------------------------------- |
    | AIPainting     | Image generation inference model. | Download the model by referring to the **README.md** file in [https://github.com/Ascend/modelzoo/tree/master/contrib/TensorFlow/Research/cv/painting/ATC_painting_tf_AE](https://github.com/Ascend/modelzoo/tree/master/contrib/TensorFlow/Research/cv/painting/ATC_painting_tf_AE). |
