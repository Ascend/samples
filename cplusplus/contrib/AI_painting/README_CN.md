...
2. 模型转换。     
    |  **模型名称**  |  **模型说明**  |  **模型下载路径**  |
    |---|---|---|
    |  AIPainting | 图片生成推理模型。  |  请参考[https://github.com/Ascend/ModelZoo-TensorFlow/tree/master/TensorFlow/contrib/cv/painting/ATC_painting_tf_AE](https://github.com/Ascend/ModelZoo-TensorFlow/tree/master/TensorFlow/contrib/cv/painting/ATC_painting_tf_AE)目录中README.md下载原始模型章节的模型文件。 |
