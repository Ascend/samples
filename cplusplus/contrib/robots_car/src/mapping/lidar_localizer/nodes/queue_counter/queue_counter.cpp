...
static void current_pose_callback(const geometry_msgs::PoseStamped::Ptr input)
{
	dequeue++;
...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber ndt_pose_sub = nh.subscribe("current_pose", 100000, current_pose_callback);
