...
2. 模型转换。     
    |  **模型名称**  |  **模型说明**  |  **模型下载路径**  |
    |---|---|---|
    |  dbnet| 基于Tensorflow的文本识检测模型。  |  [下载地址](https://obs-9be7.obs.cn-east-2.myhuaweicloud.com/models/robots_car/dbnet.om) |
    | crnn_static| 基于Tensorflow的字母识别模型。  | [下载地址](https://obs-9be7.obs.cn-east-2.myhuaweicloud.com/models/robots_car/crnn_static.om)|
