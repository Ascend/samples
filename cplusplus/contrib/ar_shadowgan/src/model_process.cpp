...
Result ModelProcess::CreateInput(void *inputDataBuffer, 
                                 void *inputDataBuffer2, 
                                 size_t bufferSize, 
                                 size_t bufferSize_2) {
    ...
    aclDataBuffer* inputData_2 = aclCreateDataBuffer(inputDataBuffer2, bufferSize_2);
    if (inputData_2 == nullptr) {
        ERROR_LOG("can't create data buffer, create input failed");
        return FAILED;
    }
    ...
    ret = aclmdlAddDatasetBuffer(input_, inputData_2);
    if (inputData_2 == nullptr) {
        ERROR_LOG("can't add data buffer, create input failed");
        aclDestroyDataBuffer(inputData_2);
        inputData_2 = nullptr;
        return FAILED;
    }
