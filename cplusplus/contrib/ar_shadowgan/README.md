...
2. Convert the model.    
    ...
    |---|---|---|
    |  ar_shadowgan | Super resolution inference model.|  Download the model by referring to the links in **README.md** in the [ModelZoo_TensorFlow](https://github.com/Ascend/ModelZoo-TensorFlow/tree/master/TensorFlow/contrib/cv/) directory of the ModelZoo repository.|
