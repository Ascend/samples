...
public:
    ...
    * @return result
    */
    AtlasError Process(ImageData& destJpegImage, ImageData& srcYuvImage);
...
private:
    AtlasError InitJpegEResource(ImageData& inputImage);
    AtlasError InitEncodeInputDesc(ImageData& inputImage);
