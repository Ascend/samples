...
input3_path=${project_path}/run/out/test_data/data/input_2.bin
input4_path=${project_path}/run/out/test_data/data/input_3.bin
input5_path=${project_path}/run/out/test_data/data/input_4.bin
output1_path=${project_path}/run/out/result_files/output_0.bin
output2_path=${project_path}/run/out/result_files/output_1.bin
...
function main() {
    ...
    python3 ${script_path}/verify_result.py ${input1_path} ${input2_path} ${input3_path} ${input4_path} ${input5_path} ${output1_path} ${output2_path}
    if [ $? -ne 0 ];then
