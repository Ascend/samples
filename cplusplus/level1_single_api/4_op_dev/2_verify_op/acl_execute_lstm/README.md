# Execution Verification of the LSTM Operator<a name="EN-US_TOPIC_0302083145"></a>
...
## Compilation and Running \(Ascend 310 EP\)<a name="section1042793885117"></a>
...
1.  Generate the single-operator offline model file of the LSTMTik operator.
    ...
    2.  Run the following command in the  **out **directory to generate a single-operator model file:
        ...
        **atc --singleop=test\_data/config/lstm\_op.json  --soc\_version=_$\{soc\_version\}_  --output=op\_models**
        ...
        The single-operator model file  **0\_LSTMTik\_xxxx.om**  is generated in the  **op\_models**  directory of the current directory. The file is named in the format of No.+opType+input description \(dateType\_format\_shape\)+output description.
...
3.  Build the sample project to generate an executable file for single-operator verification.
    1.  Go to the  **acl\_execute\_lstm**  directory of the sample project and run the following command in this directory to create a directory for storing the generated executable file, for example,  **build/intermediates/host**.
    ...
    3.  Run the following command to generate an executable file:
        ...
        **make**
        ...
        The executable file  **execute\_lstm\_op**  is generated in the  **run/out**  directory of the project.
