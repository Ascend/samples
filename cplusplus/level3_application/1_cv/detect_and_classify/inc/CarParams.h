...
const std::vector<std::string> kDetectPreName = {"detectPre_0", "detectPre_1", "detectPre_2", "detectPre_3"};
const std::vector<std::string> kInferName = {"inference_0", "inference_1", "inference_2", "inference_3"};
const std::vector<std::string> kDetectPostName = {"detectPost_0","detectPost_1", "detectPost_2","detectPost_3"};
const std::vector<std::string> kClassifyPreName = {"classifyPre_0", "classifyPre_1", "classifyPre_2", "classifyPre_3"};
const std::vector<std::string> kClassifyPostName = {"classifyPost_0","classifyPost_1", "classifyPost_2","classifyPost_3"};
}
