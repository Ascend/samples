...
Function: Use the GoogLeNet model to perform classification inference on input videos.   
...
| Third-party dependency| presentagent, opencv | For details, see [Third-Party Dependency Installation Guide (C++ Sample)](../../../environment).|
...
1. Run the following commands to upload the **googlenet_imagenet_video** directory in the development environment to any directory in the operating environment, for example, **/home/HwHiAiUser**, and log in to the operating environment (host) as the running user (**HwHiAiUser**):   
    ```
