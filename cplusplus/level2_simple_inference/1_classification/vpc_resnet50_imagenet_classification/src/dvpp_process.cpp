...
DvppProcess::DvppProcess(aclrtStream& stream) : stream_(stream), dvppChannelDesc_(nullptr),
    resizeConfig_(nullptr), decodeOutDevBuffer_(nullptr),decodeOutputDesc_(nullptr), resizeInputDesc_(nullptr),
    resizeOutputDesc_(nullptr), inDevBuffer_(nullptr),inDevBufferSize_(0), jpegDecodeOutputSize_(0),
    decodeOutputWidth_(0), decodeOutputWidthStride_(0), decodeOutputHeight_(0), resizeOutBufferDev_(nullptr),
    resizeOutBufferSize_(0), modelInputWidth_(0), modelInputHeight_(0), resizeOutWidthStride_(0),
