...
DvppProcess::DvppProcess(aclrtStream &stream)
    : g_stream_(stream), g_dvppChannelDesc_(nullptr),
      g_resizeConfig_(nullptr), g_decodeOutDevBuffer_(nullptr),
      g_decodeOutputDesc_(nullptr), g_resizeInputDesc_(nullptr),
      g_resizeOutputDesc_(nullptr), g_inDevBuffer_(nullptr), g_inDevBufferSize_(0),
      g_jpegDecodeOutputSize_(0),
      g_decodeOutputWidth_(0), g_decodeOutputWidthStride_(0),
      g_decodeOutputHeight_(0), g_resizeOutBufferDev_(nullptr),
      g_resizeOutBufferSize_(0), g_modelInputWidth_(0), g_modelInputHeight_(0),
      g_resizeOutWidthStride_(0),
...
Result DvppProcess::InitDvppOutputPara(int modelInputWidth, int modelInputHeight)
{
    ...
    g_resizeOutWidthStride_ = AlignSize(modelInputWidth, byte1); // 16-byte alignment
    g_resizeOutHeightStride_ = AlignSize(modelInputHeight, byte2); // 2-byte alignment
...
Result DvppProcess::InitResizeInputDesc()
{
    ...
    (void) acldvppSetPicDescFormat(g_resizeInputDesc_, PIXEL_FORMAT_YUV_SEMIPLANAR_420);
...
{
    // resize pic size
    aclError ret = acldvppVpcResizeAsync(g_dvppChannelDesc_, g_resizeInputDesc_,
