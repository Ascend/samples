...
## YOLOv3_VOC_detection_picture Sample
Function: Use the YOLOv3 model to perform prediction and inference on input images and print the results on the output images.    
...
1. Run the following commands to upload the **YOLOV3_VOC_detection_picture** directory in the development environment to any directory in the operating environment, for example, **/home/HwHiAiUser**, and log in to the operating environment (host) as the running user (**HwHiAiUser**):
