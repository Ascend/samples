...
## VGG_SSD_coco_detection_CV_without_AIPP Sample
...
1. Run the following commands to upload the **VGG_SSD_coco_detection_CV_without_AIPP** directory in the development environment to any directory in the operating environment, for example, **/home/HwHiAiUser**, and log in to the operating environment (host) as the running user (**HwHiAiUser**):   
    ```
