...
aipp_cfg="https://c7xcode.obs.cn-north-4.myhuaweicloud.com/models/YOLOV3_coco_detection_dynamic_AIPP/aipp_objectdetection.cfg"
model_name="yolov3"
...
function downloadDataWithVerifySource() {
    ...
    wget -O ${project_path}/verify_image/verify_dog1_1024_683.jpg ${verify_source}"verify_dog1_1024_683.jpg" --no-check-certificate
    if [ $? -ne 0 ];then
