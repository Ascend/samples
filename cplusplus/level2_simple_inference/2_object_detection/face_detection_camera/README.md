...
## Camera Detection Sample  
Function: Use the face detection model to detect faces in instant videos shot by Raspberry Pi cameras.   
Input: video shot by the camera.  
