...
## JPEGD sample
Function: Decodes images by calling the JPEGD interface of the DVPP.  
Input: JPEG images to be decoded.   
...
1. Run the following commands to upload the **jpegd** directory in the development environment to any directory in the operating environment, for example, **/home/HwHiAiUser**, and log in to the operating environment (host) as the running user (**HwHiAiUser**):
    ```
...
After running, the YUV images are generated in **out/output** in the sample directory of the running environment.
