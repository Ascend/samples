...
## Sample of Cropping
Function: Calls the DVPP crop interface to crop images.  
Input: Original YUV images.  
Output: Cropped YUV images.  
...
1. Run the following commands to upload the **crop** directory in the development environment to any directory in the operating environment, for example, **/home/HwHiAiUser**, and log in to the operating environment (host) as the running user (**HwHiAiUser**):
    ```
...
After running, the cropped YUV image is generated in **out/output** in the sample directory of the running environment.
