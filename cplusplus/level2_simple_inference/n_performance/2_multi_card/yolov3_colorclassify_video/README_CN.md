...
2. 模型转换。      
   ...
   | color        | 车辆颜色分类推理模型。是基于tensorflow的CNN模型。 | 请参考[https://github.com/Ascend/modelzoo/tree/master/contrib/TensorFlow/Research/cv/ATC_CarColor_tensorflow_AE](https://github.com/Ascend/modelzoo/tree/master/contrib/TensorFlow/Research/cv/ATC_CarColor_tensorflow_AE)目录中README.md下载原始模型章节下载模型文件。 |
