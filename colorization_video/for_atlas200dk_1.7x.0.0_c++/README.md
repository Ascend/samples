...
2.  <a name="zh-cn_topic_0219108795_li2074865610364"></a>获取此应用中所需要的网络模型。
    ...
    参考[表 黑白图像上色应用使用模型](#zh-cn_topic_0219108795_table19942111763710)获取此应用中所用到的网络模型（googlenet.prototxt）及其对应的权重文件（googlenet.caffemodel），并将其存放到Ubuntu服务器的任意目录，例如：$HOME/models/colorization_video。
