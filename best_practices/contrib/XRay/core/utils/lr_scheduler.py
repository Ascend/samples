...
# reference: https://github.com/facebookresearch/maskrcnn-benchmark/blob/
# master/maskrcnn_benchmark/solver/lr_scheduler.py
...
if __name__ == '__main__':
    ...
    lr_scheduler = WarmupPolyLR(optimz, niters=1000)
