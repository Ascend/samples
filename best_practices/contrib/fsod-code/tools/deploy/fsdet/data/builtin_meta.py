...
CUSTOM_VOC_NOVEL_CATEGORIES = {
    1: [
        "none"
    ]
}

CUSTOM_VOC_BASE_CATEGORIES = {
    1: [
        "hole",
        "crack"
    ],
...
def _get_custom_voc_fewshot_instantces_meta():
    ret = {
        "thing_classes": CUSTOM_VOC_ALL_CATEGORIES,
        "novel_classes": CUSTOM_VOC_NOVEL_CATEGORIES,
        "base_classes": CUSTOM_VOC_BASE_CATEGORIES,
    }
    return ret
...
def _get_builtin_metadata(dataset_name):
    ...
    ################## Custom VOC ########################
    elif dataset_name == "custom_voc_fewshot":
        return _get_custom_voc_fewshot_instantces_meta()
    ######################################################
