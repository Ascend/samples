...
class PascalVOCDetectionEvaluator(object):
    """
    ...
    the official API.
    """
    def __init__(self, dataset_name, labels, dirname, split):
        """
        Args:
    ...
    def process(self, inputs, outputs):
        for img_id in inputs:
            output_dict = outputs[img_id]
            ...
            for box, score, cls in zip(boxes, scores, classes):
                ...
                self._predictions[cls].append(
                    f"{img_id} {score:.3f} {xmin:.1f} {ymin:.1f} {xmax:.1f} {ymax:.1f}"
                )
    ...
    def evaluate(self):
        ...
        print(create_small_table(ret["bbox"]))
