...
class DefaultPredictor:
    ...
    def __call__(self, original_image):
        ...
        inputs = {"image_preprocess": image, "height": height, "width": width,'image_size':(height,width)}
...
class DefaultTrainer(SimpleTrainer):
    ...
    def __init__(self, cfg):
        ...
        ####################
        super().__init__(model, data_loader, optimizer, aspect_ratio_grouping=cfg.DATALOADER.ASPECT_RATIO_GROUPING)
        ####################
